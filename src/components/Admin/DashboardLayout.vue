...
export default{
    ...
    data(){
        return{
            ...
            drawer: true,
            items:[
                { title: "Dashboard", to: "/admin_dashboard" },
                { title: "Role", to: "/admin_role" },
                { title: "Mobil", to: "/admin_mobil" },
                { title: "Pemilik Mobil", to: "/admin_pemilik_mobil" },
                { title: "Pegawai", to: "/admin_pegawai" },
                { title: "Driver", to: "/admin_driver" },
            ],
        };
    },
    methods: {
