        ...
        <v-navigation-drawer v-model="drawer" class="fullheight" width="256" app>
            <v-list-item>
                <v-list-item-content>
                    ...
                    <v-list-item-subtitle>CUSTOMER SERVICE</v-list-item-subtitle>
                </v-list-item-content>
            </v-list-item>
...
export default{
    ...
    data(){
        return{
            ...
            drawer: true,
            items:[
                { title: "Dashboard", to: "/customerservice_dashboard" },
                { title: "Customer", to: "/customerservice_customer" },
                { title: "Transaksi", to: "/customerservice_transaksi" },
            ],
        };
    },
    methods: {
